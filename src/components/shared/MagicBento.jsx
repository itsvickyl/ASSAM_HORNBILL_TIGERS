...
const DEFAULT_GLOW_COLOR = '201, 162, 39'; // Team Gold RGB
...
const defaultCardData = [
  ...
  {
    color: '#1C0000',
    title: 'Kini Sports Arena, Bangalore Host Ground',
    description: 'High-intensity night games under lights with challenging dew conditions demanding tactical precision from the Tigers.',
    label: 'Match Center'
  },
  {
    color: '#250000',
    title: 'Official Partners & Apparel',
    description: 'Backed by MVP Partner RYOTO, Performance Accessory Partner NOTCH, Food Partner JEFFS GROUP, and ACT Fibernet.',
    label: 'Club Partners'
  },
  {
    color: '#200000',
    title: 'ISCL Season 1 Championship Campaign',
    description: 'Hornbill Tigers charge into the standings following their thrilling triumph over Delhi Dare Strikers.',
